/*
  Display the genesis block message byy Satoshi.
*/
#include <iostream>
...
int main()
{
	...
	// Genesis block contains a single coinbase transaction.	assert(block.transaction.size() == 1);
	const bc::transaction_type& coinbase_tx = block.transaction[0];
